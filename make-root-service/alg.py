    ...
    while improvement:
        ...
        for i in range(0, n):
            for j in range(i, n):
                ...
                new_final_route , new_distance, new_n_tardy, new_tardy_mean, _, _, _ = alg2.compact(new_route_string, dist_matrix, node_limit)
                if is_better([new_n_tardy, new_tardy_mean, new_distance], [best_n_tardy, best_tardy_mean, best_distance]):
